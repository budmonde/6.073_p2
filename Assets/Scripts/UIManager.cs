...
public class UIManager : MonoBehaviour {
	...
	void Update() {
		...
		//manaMask.GetComponent<RectTransform>().rect.Set(manaNominal.x, manaNominal.y, manaRatio * manaNominal.width, manaNominal.height);
		//wHealthMask.GetComponent<RectTransform>().rect.Set(wHealthNominal.x, wHealthNominal.y, wHealthRatio * wHealthNominal.width, wHealthNominal.height);
		//fHealthMask.GetComponent<RectTransform>().rect.Set(fHealthNominal.x, fHealthNominal.y, fHealthRatio * fHealthNominal.width, fHealthNominal.height);
